...
function AllEvent() {
  ...
  <div className="flex items-center p-4  mt-6 rounded-lg ">
    ...
    <g clipPath="url(#__lottie_element_755)">
      <g transform="matrix(1.1849666833877563,0,0,1.1849666833877563,-1.1731643676757812,-1.1731643676757812)" opacity="1" style={{ display: 'block' }}>
      ...
      <g transform="matrix(1.1849666833877563,0,0,1.1849666833877563,29.043485641479492,30.228452682495117)" opacity="1" style={{ display: 'block' }}>
      ...
      <g transform="matrix(1.1849666833877563,0,0,1.1849666833877563,36.3150749206543,18.971269607543945)" opacity="1" style={{ display: 'block' }}>
      ...
      <g transform="matrix(1.1849666833877563,0,0,1.1849666833877563,62.70454406738281,48.595436096191406)" opacity="1" style={{ display: 'block' }}>
        <g opacity="1" transform="matrix(1,0,0,1,13,13)">
          <path
            strokeLinecap="butt"
            strokeLinejoin="miter"
      ...
      <g transform="matrix(1.1849666833877563,0,0,1.1849666833877563,41.52058792114258,78.2196044921875)" opacity="1" style={{ display: 'block' }}>
        <g opacity="1" transform="matrix(1,0,0,1,13,13)">
          <path
            strokeLinecap="butt"
            strokeLinejoin="miter"
  ...
  <hr />
  <div className="flex items-center p-4 mt-6 rounded-lg"> <svg xmlns="http://www.w3.org/2000/svg" width="15" height="20" viewBox="0 0 24 24">
 ...
 <h2 className="text-lg font-cursive ml-2 ">Type</h2></div>
