      ...
      <div className="">
        <div className="relative text-gray-700 bg-clip-border rounded-xl group transition-all duration-300">
          <div className="relative overflow-hidden text-white rounded-xl">
            ...
            />
            <div className="absolute inset-0 flex flex-col items-start justify-start bg-black bg-opacity-50 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              <h5 className="text-white text-2xl font-semibold mt-44 ml-3">
                {data.typeproduct}
              </h5>
              <p className="text-white text-lg font-semibold text-center ml-3">
                {data.price} EGP
              </p>
