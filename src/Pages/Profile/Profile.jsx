...
import { FaInstagram, FaLinkedinIn, FaFacebookF, FaUserEdit } from "react-icons/fa";
              ...
              <div className="mt-10">
                ...
                {loadingReviews ? (
                  ...
                  reviewsData.map((review) => (
                    <div key={review.id} className="my-4 p-4 border rounded-lg shadow w-[90%]">
                      ...
                      <p className="text-sm text-gray-500">{review.rating} / 5 stars</p>
                    </div>
                  ))
                ) : (
