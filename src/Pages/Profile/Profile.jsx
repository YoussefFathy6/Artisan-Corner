...
function Profile() {
  ...
  // const [cont, setcont] = useState({ events: 0, products: 0, reviews: 0 });
  ...
  useEffect(() => {
    ...
    if (userid) {
      // Query to fetch products related to the specific userId
          ...
          <div className="mt-10 mb-56 lg:mt-28 flex flex-col items-center rounded-xl" key={index}>
            ...
            <div className=" lg:mt-30 lg:w-1/2 flex flex-col items-center">
              <img
                ...
                alt="Profile"
                className="rounded-[100%] border-4 border-red-800 lg:w-72 lg:h-72 object-cover mx-auto transition-transform duration-500 ease-in-out hover:scale-110"
              />
  ...
  <>
    {/* <div className="flex justify-around items-center mt-10 lg:mt-20">
      <div className="text-center">
        <h2 className="text-3xl lg:text-5xl mb-2 lg:mb-3">+{cont.events}</h2>
        <h2 className="text-xl lg:text-3xl">Events</h2>
      </div>
      <div className="text-center">
        <h2 className="text-3xl lg:text-5xl mb-2 lg:mb-3">+{cont.products}</h2>
