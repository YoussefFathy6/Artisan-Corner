  ...
  return (
    <div className="flex m-4 lg:flex-row justify-between">
      ...
      <div className=" mr-8 w-[95%]">
        ...
        <div className="mt-10 mb-56 bg-slate-400 p-7 lg:mt-28 flex justify-between rounded-xl" key={index}>
        {data.length > 0 && data[0].accountType !== "Artist" && (  <div>
           <Link to="/adddeitalsprofile">
            ...
            <div className="lg:mt-30 lg:w-1/2 flex flex-col items-center">
              <img
                ...
                alt="Profile"
                className="rounded-full border-4 border-white lg:w-72 lg:h-72 object-cover mx-auto transition-transform duration-500 ease-in-out hover:scale-110"
              />
            ...
            <div className="mt-10 lg:mt-12 mr-16 lg:w-1/2">
              <h1 className="text-3xl lg:text-4xl lg:mb-5">{item.firstname} {item.lastname}</h1>
              <h4 className="text-xl lg:text-2xl  font-bold lg:mb-3">About</h4>
              <h4 className="text-xl lg:text-1xl">{item.about}</h4>
            </div>
          </div>
        ))}
            ...
            <div >
              ...
              <div className=" ">
                {products.length ? (
                  ...
                  <div className="m-auto text-center"> <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="loader m-auto items-center  ">
